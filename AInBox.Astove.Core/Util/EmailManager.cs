...
namespace AInBox.Astove.Core.Util
{
    public class EmailManager
    {
        ...
        public async static Task SendEmail(string subject, string messageHtml, string messageText, string[] to, Encoding subjectEncoding = null, Encoding bodyEncoding = null, string[] cc = null, string[] bcc = null, string from = "campeaovendas@yesfeiras.com.br", string fromName = "Campeão de Vendas", Attachment attach = null)
        {
            if (string.IsNullOrEmpty(subject))
                throw new ArgumentNullException(nameof(subject));

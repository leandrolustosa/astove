...
namespace AInBox.Astove.Core.Extensions
{
    public static class DoubleExtensions
    {
        ...
        {
            return value.ToString("#,##0.00", AInBox.Astove.Core.Globalization.Cultures.PTBR);
        }

        public static string ToStringEnUs(this double value)
        {
            return value.ToString("#,##0.00", AInBox.Astove.Core.Globalization.Cultures.PTBR);
        }
        ...
        public static string ToExtenso(this double valor)
        {
            ...
            else
            {
                ...
                {
                    valor_por_extenso += EscrevaParte(Convert.ToDouble(strValor.Substring(i, 3)));
        ...
        private static string EscrevaParte(double valor)
        {
            if (valor <= 0)
                return string.Empty;
            else

...
namespace AInBox.Astove.Core.Model
{
    ...
    public class ChangePasswordBindingModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "A {0} deve conter no máximo {2} caracteres.", MinimumLength = 4)]
        [DataType(DataType.Password)]
    ...
    public class SendVerificationCodeBindingModel
    {
        [Required]
        [Display(Name = "e-mail")]
        [StringLength(30, ErrorMessage = "O {0} deve conter no máximo {2} caracteres.")]
        public string Email { get; set; }
    }
}
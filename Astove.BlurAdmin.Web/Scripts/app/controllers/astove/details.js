(function () {
    ...
    angular.module('AstoveApp').controller('DetailsCtrl', ['$scope', '$routeParams', 'messageBoxService', 'AstoveService', 'AstoveFilter', 'AstoveData', 'AstoveFile', 'AstoveCommon', 'cfpLoadingBar', 'AstoveFileResource', '$timeout',
            function ($scope, $routeParams, messageBoxService, $service, $filter, $data, $file, $global, cfpLoadingBar, AstoveFileResource, $timeout) {
                $global.loading = true;

(function () {
    ...
    angular.module('AstoveApp').controller('DetailsCtrl', ['$scope', '$stateParams', 'messageBoxService', 'AstoveService', 'AstoveFilter', 'AstoveData', 'AstoveFile', 'AstoveCommon', 'AstoveFileResource', '$timeout',
            function ($scope, $stateParams, messageBoxService, $service, $filter, $data, $file, $global, AstoveFileResource, $timeout) {
                $global.loading = true;
                $scope.entityNameUpdate = (typeof $stateParams.entityName === 'undefined' || $stateParams.entityName === null || $stateParams.entityName === '') ? $scope.entityName : $stateParams.entityName;
                $scope.forms = {};
